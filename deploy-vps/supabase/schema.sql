-- =============================================================================
-- LIBERTY PHARMA — SCHEMA COMPLETO PARA NOVO PROJETO SUPABASE
-- =============================================================================
-- Como usar:
--   1. Crie um projeto novo em https://supabase.com/dashboard
--   2. Vá em SQL Editor → New Query
--   3. Cole TODO este arquivo e clique em "Run" (1 só clique)
--   4. Vá em Project Settings → API → copie URL e anon key
--   5. No instalador da VPS, informe esses valores quando solicitado
--
-- Inclui:
--   - 22 tabelas (com colunas, defaults, constraints e índices únicos)
--   - Enum app_role
--   - 5 funções (has_role, increment_coupon_usage, update_updated_at_column,
--     ensure_single_default_address, handle_new_user)
--   - 14 triggers (updated_at + addresses default + auth user → profile)
--   - Todas as RLS policies (38 políticas)
--   - 3 buckets de storage públicos (product-images, testimonial-videos,
--     banner-images) com policies
-- =============================================================================
...
-- pg_cron e pg_net são opcionais (habilitar via Database → Extensions no painel)
...
-- =============================================================================
-- FIM. Próximos passos:
--   1. Authentication → Providers → Email: ative e desmarque "Confirm email"
--      se quiser auto-confirm (recomendado para começar)
--   2. Crie um usuário em Authentication → Users
--   3. Promova-o a admin rodando:
--        INSERT INTO public.user_roles (user_id, role)
--        VALUES ('<UUID_DO_USUARIO>', 'admin');
--   4. Edge Functions: faça deploy manual de cada função em supabase/functions/
--      via Supabase CLI ou painel
-- =============================================================================
