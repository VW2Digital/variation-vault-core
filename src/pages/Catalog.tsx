              ...
              return (
                <StaggerItem key={variation?.id || `${product.id}-${idx}`}>
                  ...
                  >
                    ...
                    >
                      {/* Image */}
                      <div className={`relative aspect-[1080/1450] bg-white flex items-center justify-center overflow-hidden ${ab.variant === 'B' ? 'p-2 sm:p-2.5 border-b border-border/40' : 'p-[20px]'}`}>
                        <img
                          src={img}
                          alt={displayName}
                          loading="lazy"
